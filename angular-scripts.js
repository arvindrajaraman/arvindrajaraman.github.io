...
app.controller('TeachingController', function($scope) {
    $scope.courseContent = [
        ...
        {num: 5, weekOf: '2/13', description: 'First-Order Logic, Intro to Naive Bayes', wsLink: 'https://inst.eecs.berkeley.edu/~cs188/sp22/assets/section/section05.pdf', wsaLink: '', sLink: 'https://docs.google.com/presentation/d/1nq5mHuWhPrNY78H-8Ugqvv3fY4LZWdLaTvXj2LEF_j4/edit?usp=sharing'},
